...
<section id="main_section" class="sliderphoto innerphoto" style="background:url(/images/slide5.jpg) fixed center center no-repeat; background-size:cover;">
  <div class="container">
    <div class="loginbok cand-1">
      ...
      <form  action="{{ url('/SuccessStory/store/').'/'.$data->id }}" method="post"  class="formlogin" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="divwits iconfont">
           <textarea type="text" name="description" class="form-control" placeholder="talk about you experinces" >
           </textarea> 
        </div>
        ...
        <div class="divwits">
          <div class="row">
            <div class="col-sm-4 createbot">
              <button type="submit"   class="largeredbtn"> Add Story </button>
            </div>
          </div>
          <!--row--> 
