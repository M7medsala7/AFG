...
<div class="modal fade bd-example-modal-lg" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <div class="col-lg-12">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">Edit {{$Job->name }} </h3>
                                  </div>
                                   <hr>
  <form  action="/editjob" method="post"  class="formlogin mergform"  novalidate enctype="multipart/form-data">
  ...
  <legend style="width: fit-content;border: 0px;">Jobs Data:</legend>
  ...
  <div class="form-row">
   <div class="col-md-4 mb-3">
     ...
     <input  type="text" class="form-control "  id="name" value="{{$Job->name }}" name="name">
    </div>
    <br> 
       ...
       <div class="ln_solid"></div>
          ...
          <!-- <a  class="btn btn-primary " href="/offlineneew/public/users">Cancel</a> -->
                         <!-- <button class="btn btn-primary" type="reset">Reset</button> -->
                          <button type="submit"  name="login_form_submit" class="btn btn-success"  >Edit Job</button>
                        </div>
                      </div>
</form>
