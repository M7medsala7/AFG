...
<form  action="/addjob" method="POST" id="profileForm" class="formlogin" enctype="multipart/form-data">
	{{ csrf_field() }}
   ...
   <fieldset style="padding: .35em .625em .75em; margin: 0 2px; border: 1px solid silver;">
      ...
      <div class="col-lg-12">
                  ...
                  <input type="text" id="hf-name" name="name" placeholder="Enter Job name..." class="form-control">
                    </div>
                    <div class="row form-group">
...
Add New Job
 ...
 <button style="margin: 5px;" class="btn btn-danger btn-xs delete-all" data-url="">Delete All</button>
                ...
                <td><input type="checkbox" class="checkbox" data-id="{{$value->id}}"></td>
                  <td>{{$value->name}}</td>
                  <td>
                  <a href="{{url('/ShowEditjob/'.$value->id)}}" class="btn btn-default btn-sm"> <span class="fa fa-edit"></span>  </a>
