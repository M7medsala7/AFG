                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col-xs-12 col-sm-4">
                           <figure>
                              <img class="img-circle img-responsive"  src="{{($employeradmin->logo)?$employeradmin->logo:'/images/textbotphot.jpg'}}">
                           </figure>
                           <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                           <ul class="list-group">
                              <li class="list-group-item">{{  $employeradmin->name}}</li>
                              @if(is_null($employeradmin->EmpInfo))
                              <li class="list-group-item">------ </li>
                              @else
                              <li class="list-group-item">{{  $employeradmin->EmpInfo->last_name}}</li>
                              @endif
                              @if(is_null($employeradmin->EmpInfo))
                              <li class="list-group-item"><i class="fa fa-phone"></i> 000-000-0000 </li>
                              @else
                                <li class="list-group-item"><i class="fa fa-phone"></i> {{$employeradmin->EmpInfo->phone}} </li>
                                @endif
                              <li class="list-group-item"><i class="fa fa-envelope"></i> {{$employeradmin->email}}</li>
 @if(is_null($employeradmin->EmpInfo))
                              <li class="list-group-item"><i class="fa fa-phone"></i>  </li>
                              @else
                                <li class="list-group-item"> {{$employeradmin->EmpInfo->type}} </li>
                                @endif
...
<div class="form-row">
     ...
     <input type="text" class="form-control "  id="country" value=" {{isset($employeradmin->EmpInfo->country) ? $employeradmin->EmpInfo->country->name: ''}}" name="country" disabled="">
     ...
     <input type="text" class="form-control "  id="city" value=" {{isset($employeradmin->EmpInfo->city) ? $employeradmin->EmpInfo->city->name: ''}}" name="city" disabled="">
