...
<section class="dashboard">
    ...
    <div class="row">
      <div class="col-sm-12">
      <div class="inner-aboutus" style="margin-top:1px"  >
...
<h6 style="    text-align: center;
    color: #043d77;
    margin-top: 11px;font-size: x-large;">your shared candidate</h6>
 </div>
<div class="col-md-12" style="margin-bottom: 25px;">

 <nav class="menu-tab">
  <a  onclick="drawtable('All',1,'1')" id="div1" style="background:#043d77">
  <span>{{$all}}</span>All</a>

   <a onclick="drawtable('shortlisted',2,'1')" id="div2">
  <span>{{$Shortlisted}}</span> Shortlisted</a>

  <a onclick="drawtable('Rejected',3,'1')" id="div3">
  <span>{{$Rejected}}</span>Rejected</a>

    <a onclick="drawtable('Interview',4,'1')" id="div4">
    <span>{{$Interview}}</span> Interview</a> 
    <a onclick="drawtable('Reference Check',5,'1')" id="div5">
    <span>{{$ReferenceCheck}}</span> Reference Check</a>
     <a onclick="drawtable('Salary Finalization',6,'1')" id="div6">
     <span>{{$SalaryFinalization}}</span> Salary Finalization</a>
   <a onclick="drawtable('Send to Itegration',7,'1')" id="div7">
 
 <span>{{$SendItegration}}</span> Send to Itegration</a> </nav>
 
 </div>
<div class="col-md-12" style="min-height:800px">  @include('Client.sharedclientpartial')</div>
...
<div class="modal fade" id="updatestatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <div class="col-md-6 mb-6">
        ...
        Add your comment:
        <div class="col-md-12">
        <textarea col="7" style="background: lightblue;width: 100%;" name="comment"></textarea>
        </div>
        </div>  
