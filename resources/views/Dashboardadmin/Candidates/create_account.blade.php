...
@endif
   ...
   <form  role="form" method="POST" action="{{ url('/adminpanel/candidates/stor') }}" enctype="multipart/form-data">
...
<input required="" type="text" style="background-color: transparent;" 
 ...
 onfocus="(this.type='date')" >                           
                  ...
                  <div  class="input-group input-file" name="logo">
                   ...
                   <td style="width:50%;">
                    ...
                    class="text2{{ $errors->has(' cv_path') ? ' is-invalid' : '' }}" 
                                name="  cv_path" value="{{ old(' cv_path') }}"
                  ...
                  <input  type="text" style="background-color: transparent;" class="form-control requirments calendar" name="visa_expire_date" placeholder="expired date visa" onfocus="(this.type='date')" />
                ...
                <td style="width:50%;">
                            ...
                            name="language_ids[]" id="language_id" multiple="multiple" required="" >
                       ...
                       <tr>
                       <td style="width:50%;">
                            <select  class="form-control requirments" id="eductional_level" name="Eductionlevel" required="" >
                ...
                <option >Masters</option>
                            ...
                            <select  class="form-control chosen-select types" 
                            name="skill_ids[]" multiple="multiple"  id="skill_ids"   required="" >
                     ...
                     <td style="width:50%;">
                                  ...
                                  <input  type="text" 
                                  class="form-control requirments" placeholder="other skills">
                ...
                class="text2{{ $errors->has(' looking_for_job') ? ' is-invalid' : '' }}" 
                                name="  looking_for_job" value="{{ old(' looking_for_job') }}">
            ...
            <td style="width:50%;">      
                            <select  class="form-control requirments" 
                            name="CurrencyId" id="currency_id"  required="" >
                      ...
                      <td style="width:50%;">
                            <select  class="form-control requirments" 
                            name="prefered_location_id" id="prefered_location_id"  required="" >
            ...
            <select   multiple="multiple" class="form-control chosen-select types" name="prefered_location_ids[]"  required="" style="width: 90%;" onblur="processForm(this.form)">
...
<tr><td style="width:50%;">
             <input   required=""
              ...
              class="form-control requirments calendar" 
              name="start_date" placeholder="from" 
              onfocus="(this.type='date')"/>
              </td> 
              <td style="width:50%;"> 
