...
@endif
   ...
   <form  role="form" method="POST" action="{{ url('/adminpanel/employer/update/').'/'.$data->id }}" enctype="multipart/form-data">
                  ...
                  <span class="label-text">agency</span> </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="divwits">
                                ...
                                name="  first_name" value="First_Name:{{$data->first_name}}"
                                 >
                            </div>
                       ...
                       <div class="form-group row">
                            ...
                            <div class="divwits">
                                ...
                                name="  address" value="Address: {{ $data->address}}">
                            </div>
                        ...
                        <div class="form-group row">
                          ...
                          <option value="{{ $data->country_id}}">{{$country->name}}</option>
                               @endforeach
                          ...
                          <option value="{{ $data->city_id}}">{{$city->name}}</option>
                               @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                            <input style="width:50%;" value="E-mial:{{$data->user->email}}" type="email" name="email" class="form-control" placeholder="email address" 
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-10">
                            <input style="width:50%;" value="Password:{{$data->user->password}}" type="password" name="password" class="form-control" placeholder=" password" 
