  ...
  <div class="content-wrapper">
    ...
    Post Questions
      ...
      <ol class="breadcrumb">
        ...
        <li class=""><a href="{{url('/adminpanel/questions')}}"> Question controlling </a></li>
...
@endif
   ...
   <form  role="form" method="POST" action="{{ url('/adminpanel/question/update/').'/'.$data->id }}" enctype="multipart/form-data">
...
<table style="width:60%; border-collapse: collapse; border: 3px solid #ddd;
 ...
 <td style="width:47%;" >
                    ...
                    value="{{$data->question}}" name="question" id="question" class="form-control">
                 
                 
                   <div >
                   </td>
                   <td style="width:10%;" id="mylist">
                   <select  class="form-control requirments"  value="{{$data->weight}}" name="weight" id="weight" >
