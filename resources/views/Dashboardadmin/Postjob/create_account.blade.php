...
@endif
   ...
   <form  role="form" method="POST" action="{{ url('/adminpanel/postjob/stor') }}" enctype="multipart/form-data">
  ...
  <div role="tabpanel" class="tab-pane tabs-inner" id="step-3">
            ...
            <div class="divwits" > 
              ...
              <input style="width:50%;" type="text" name="name" class="form-control requirments" placeholder="company name" onblur="processForm(this.form)">
            </div>
<br>
              <div class="divwits" > 
              <!--<label class="desired">company name</label>-->
              <input style="width:50%;" type="text" name="name" class="form-control requirments" placeholder="user name" onblur="processForm(this.form)">
            </div>
            <!--divwits-->
            <br>
            <div class="divwits"> 
